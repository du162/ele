...
@section("content")
    <form action="" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="logo" value="{{old('logo')}}" class="col-sm-9 form-control"><br>
            </div>
        </div>
        <br><br>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="radio" name="status" value="1" > <i class="btn btn-info
glyphicon glyphicon-ok"></i>

                <input type="radio" name="status" value="0" ><i class="btn btn-info
